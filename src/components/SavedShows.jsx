...
const SavedShows = () => {
  ...
  return (
    ...
    <div className='relative flex items-center group'>
        ...
        <div id={'slider'} className='w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar scroll-bar-hide relative '>
            {movies.map((item,id)=>(
                ...
                <p className='white-space-normal text-xs md:text-sm font-bold flex justify-center items-center h-full break-all text-center  '>
                    {item?.title}
                </p>
